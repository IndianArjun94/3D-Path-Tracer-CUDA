...
public class PresetScenes {
    public static void loadScene(int scene, ArrayList<Triangle> triangles, ArrayList<Sphere> spheres, ArrayList<PointLight> pointLights, Vec3 positionOffset) {
        if (scene == 1) {
            // --- MATERIALS ---
            Material matFloor = new Material(new Vec3(220, 220, 220), 0f, 0.7f);
            Material matBackWall = new Material(new Vec3(160, 160, 160), 0f, 0.5f);
            Material matLeftWall = new Material(new Vec3(255, 65, 65), 1f, 0.4f);
            Material matRightWall = new Material(new Vec3(65, 255, 65), 1f, 0.4f);
            Material matCeiling = new Material(new Vec3(100, 100, 100), 0f, 0.9f);

            Material matCenterSphere = new Material(new Vec3(255, 255, 255), 1f, 0.05f);
            Material matOrangeSphere = new Material(new Vec3(255, 165, 0), 1f, 0.8f);
            Material matBlueSphere = new Material(new Vec3(0, 191, 255), 1f, 0.6f);
            Material matVioletSphere = new Material(new Vec3(238, 130, 238), 1f, 0.4f);
            Material matYellowSphere = new Material(new Vec3(255, 255, 0), 1f, 0.2f);
...
// --- SPHERES ---
            ...
            spheres.add(new Sphere(new Vec3(2.0f, -2.2f, -3.5f).add(positionOffset), 0.5f, matBlueSphere));    // Glossy Deep Blue (Right)
